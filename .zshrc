# CodeFluent's .zshrc. Ctrl+F the term "CUSTOM" to find the custom set variables.
...
# Path to your oh-my-zsh installation.
  export ZSH=/home/codefluent/.oh-my-zsh
...
alias adb="$HOME/bin/adb/platform-tools/adb"
alias cls="clear"
